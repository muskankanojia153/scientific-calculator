...
label1=tk.Label(window,text="CALCULATOR",relief=RIDGE,borderwidth=3,width=49,fg="YELLOW",bg="#EEA9B8")
label1.config(font=('Roman', 13))
label1.place(x=0,y=0)
# Last line Label
label1=tk.Label(window,text="~MADE BY MUSKAN ",relief=RIDGE,borderwidth=5,width=49,fg="black",bg="#C67171")
label1.config(font=('italic', 10))
label1.place(x=0,y=582)

# First Entry Box
text1 = tk.Entry(master=window, width=27,relief=SUNKEN,borderwidth=10,bg="#03A89E")
text1.config(font=('Arial bold', 19))
text1.place(x=0, y=70)
# Second Entry Box
text2 = tk.Entry(master=window, width=27,relief=RIDGE,borderwidth=10,bg="#B0E0E6")
text2.config(font=('Arial bold', 19))
text2.place(x=0, y=135)

# Frame to design Keys
frame = Frame(master=window,width=400,height=400,bg="LIGHT PINK")
...
def rating():
    ...
    webbrowser.open('www.calculator.net/scientific-calculator.html') 
    close()
...
# All the BUTTONS of CALCULATOR
   # Top 5 buttons
but26 = tk.Button(frame1, text="Website",width=8,height=1,borderwidth=10, relief=tk.RAISED, fg="grey", bg="#EE82EE",command=website)
but26.config(font=('default',8))
but26.grid(row = 0, column = 0,padx=1)
but27 = tk.Button(frame1, text="Rate Us",width=8,height=1,borderwidth=10, relief=tk.RAISED, fg="grey", bg="#00BFFF",command=rating)
but27.config(font=('default',8))
but27.grid(row = 0, column = 1,padx=1)
but28 = tk.Button(frame1, text="Reset",width=8,height=1,borderwidth=10, relief=tk.RAISED, fg="grey", bg="#E3A869",command=reset)
but28.config(font=('default',8))
but28.grid(row = 0, column = 2,padx=1)
but29 = tk.Button(frame1, text="History(H)",width=8,height=1,borderwidth=10, relief=tk.RAISED, fg="grey", bg="PINK",command=history)
but29.config(font=('default', 8))
but29.grid(row = 0, column = 3,padx=1)
but30 = tk.Button(frame1, text="Close(X)",width=8,height=1,borderwidth=10, relief=tk.RAISED, fg="grey", bg="red",command=close)
but30.config(font=('default', 8))
but30.grid(row = 0, column = 4,padx=1)

    # All the calculator button
#ROW 1
but1 = tk.Button(frame, text="AC",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="PURPLE", bg="#FF69B4",command=delall)
but1.config(font=('arial bold', 20))
but1.grid(row = 0, column = 0)

but2 = tk.Button(frame, text="C",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="PURPLE", bg="#FF69B4",command=clr1)
but2.config(font=('Arial bold', 20))
but2.grid(row = 0, column = 1)

but3 = tk.Button(frame, text="%",width=3,height=1,borderwidth=12, relief=tk.RAISED, fg="PURPLE", bg="#FF69B4")
but3.config(font=('Arial bold', 20))
but3.grid(row = 0, column = 2)

but4 = tk.Button(frame, text="/", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="PURPLE", bg="#FF69B4",command=bt4)
but4.config(font=('Arial bold', 20))
but4.grid(row = 0, column = 3)

but5 = tk.Button(frame, text="(", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="PURPLE", bg="#FF69B4",command=bt5)
...
but8.config(font=('default', 20))
but8.grid(row = 1, column = 2)

but9 = tk.Button(frame, text="*", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="PURPLE", bg="#FF69B4",command=bt9)
but9.config(font=('arial bold', 20))
but9.grid(row = 1, column = 3)

but10 = tk.Button(frame, text=")", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="PURPLE", bg="#FF69B4",command=bt10)
...
but13.config(font=('default', 20))
but13.grid(row = 2, column = 2)

but14 = tk.Button(frame, text="-", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="PURPLE", bg="#FF69B4",command=bt14)
but14.config(font=('default', 20))
but14.grid(row = 2, column = 3)

but15 = tk.Button(frame, text="√", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="PURPLE", bg="#FF69B4",command=bt15)
but15.config(font=('default', 20))
...
but18.config(font=('drfault', 20))
but18.grid(row = 3, column = 2)

but19 = tk.Button(frame, text="+", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="PURPLE", bg="#FF69B4",command=bt19)
but19.config(font=('default', 20))
but19.grid(row = 3, column = 3)

but20 = tk.Button(frame, text="^", width=3,height=1,borderwidth=12,relief=tk.RAISED, fg="PURPLE", bg="#FF69B4",command=bt20)
but20.config(font=('default', 20))
...
but23.config(font=('default', 20))
but23.grid(row = 4, column = 2)

but24 = tk.Button(window, text="=", width=8,height= 0,borderwidth=12,relief=tk.RAISED, fg="PURPLE", bg="#FF69B4",command=result)
but24.config(font=('default', 20))
